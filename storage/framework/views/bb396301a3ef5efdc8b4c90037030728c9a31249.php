...
if (isset($messageCache)) { $message = $messageCache; }
                   ...
                   name="fname"
                   value="<?php echo e(old('fname') ?? $student->fname); ?>"
                   autocomplete="name" autofocus>
            ...
            <div>
                ...
                <select name="group_id">
                    ...
                    <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($group->id); ?>" <?php if($group->id == $student->group_id): ?> selected="selected" <?php endif; ?>><?php echo e($group->name); ?></option>
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            <select name="uni_id">
                ...
                <?php $__currentLoopData = $universities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $university): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option value="<?php echo e($university->id); ?>" <?php if($university->id == $student->uni_id): ?> selected="selected" <?php endif; ?>><?php echo e($university->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
if (isset($messageCache)) { $message = $messageCache; }
                       ...
                       name="exp_res"
                       value="<?php echo e(old('exp_res') ?? $student->exp_res); ?>"
                       autocomplete="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                      ...
                      name="misc"
                      autocomplete="name" autofocus><?php echo e($student->misc); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
        ...
        <div class="pt-4">
            <a href="/students/<?php echo e($student->id); ?>/delete"><button class="btn btn-primary">Удалить</button></a>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\reports_website\resources\views//students/edit.blade.php ENDPATH**/ ?>